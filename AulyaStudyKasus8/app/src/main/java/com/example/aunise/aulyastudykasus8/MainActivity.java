...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        salon = getResources().getStringArray(R.array.salon);

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,salon);
        ...
        btnPesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent pesan = new Intent(MainActivity.this,Main2Activity.class);
                if (strTanggal.matches("Tanggal")||strWaktu.matches("Waktu")){
                    ...
                    pesan.putExtra("salon",salon[index]);
